...
class PastorAI : public AI {
	...
	public:
		...
		int compare_move(int a, int b, int best_move, int killer_1, int killer_2, int mvv_a, int lva_a, int mvv_b, int lva_b, std::array<int, 65536> *history_table = nullptr);
