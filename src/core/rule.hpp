...
class Rule : public godot::Object
{
	...
	public:
		...
		virtual void search(State *_state, int _group, godot::PackedInt32Array _main_variation, TranspositionTable *_transposition_table, godot::Callable _is_timeup, int _max_depth, godot::Callable _debug_output);
